...
local rotatIconBf = true -- icon faces up or down
local rotatIconDad = true -- icon faces up or down
...
function onCreatePost()
	if not songName == 'Moon' or not songName == 'Pissing' then
		close(true)
	end
end
...
function onCreatePost()
	...
	setProperty('scoreTxt.y', getProperty('scoreTxt.y') -75)
end
	--[[if bpm <= 115 then
